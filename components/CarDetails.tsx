            ...
            <Dialog as="div" className="relative z-10" onClose={closeModal}>
                ...
                <div className="fixed inset-0 overflow-y-auto">
                    <div className="flex min-h-full items-center justify-center p-4 text-center">
                        ...
                        >
                            <Dialog.Panel className="relative w-full max-w-lg ax-h-[90vh] overflow-y-auto transform rounded-2xl bg-white text-left shadow-xl transition-all flex flex-col gap-5 p-6">
                                ...
                                <div className="flex-1 flex flex-col p-6">
                                    ...
                                    <div className="mt-6 flex flex-col flex-wrap gap-4">
                                        {Object.entries(car).map(([key, value]) => (
                                            <div className="flex justify-between gap-5 text-right" key={key}>
